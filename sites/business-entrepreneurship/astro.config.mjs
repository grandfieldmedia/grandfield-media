...
// Grandfield Business — commerce niche site (Astro 7 + Tailwind 4 + Vercel adapter).
export default defineConfig({
  site: 'https://grandfieldbusiness.com',
  output: 'server',
  adapter: vercel(),
  ...
  vite: {
    ...
    cacheDir: join(tmpdir(), 'vite-business-entrepreneurship'),
  },
});
