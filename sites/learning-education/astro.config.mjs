...
// Grandfield Learning — commerce niche site (Astro 7 + Tailwind 4 + Vercel adapter).
export default defineConfig({
  site: 'https://grandfieldlearning.com',
  output: 'server',
  adapter: vercel(),
  ...
  vite: {
    ...
    cacheDir: join(tmpdir(), 'vite-learning-education'),
  },
});
